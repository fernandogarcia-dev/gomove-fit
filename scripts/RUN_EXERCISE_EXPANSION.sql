...
--
-- Adds ~80 exercises on top of the initial 16 (idempotent: skips existing names).
-- After running, you should see ~96 rows:
...
SELECT body_region, COUNT(*) AS n FROM public.exercises GROUP BY body_region ORDER BY body_region;
